...
export default function PopupVideoLayout({ thumbnails }: VideoLayoutProps) {
    ...
    return (
        <>
            ...
            />
            <Controls.Root
                className={`${styles.controls} media-controls:opacity-100 text-white absolute inset-0 z-10 flex h-full w-full flex-col bg-gradient-to-t from-black/10 to-transparent opacity-0 transition-opacity`}
            >
                ...
                <div className="absolute bottom-0 start-0 w-full h-[24rem] video-modal-layout-shadow -z-10"></div>
            </Controls.Root>
        </>
    )
}
